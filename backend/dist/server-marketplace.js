...
// Routes
app.use('/api/marketplace', auth_middleware_1.authenticateUser, marketplace_routes_1.default);
app.use('/api/checkout', auth_middleware_1.authenticateUser, checkout_routes_1.default);
