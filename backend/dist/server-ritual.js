...
const rituals_routes_1 = __importDefault(require("./routes/rituals.routes"));
const metamorphosis_routes_1 = __importDefault(require("./routes/metamorphosis.routes"));
...
// Routes
app.use('/api/rituals', auth_middleware_1.authenticateUser, rituals_routes_1.default);
app.use('/api/metamorphosis', auth_middleware_1.authenticateUser, metamorphosis_routes_1.default);
