...
exports.getEvents = (0, async_middleware_1.asyncHandler)(async (req, res) => {
...
exports.createEvent = (0, async_middleware_1.asyncHandler)(async (req, res) => {
    const userId = req.user?.userId;
...
exports.syncToMobile = (0, async_middleware_1.asyncHandler)(async (req, res) => {
    const userId = req.user?.userId;
    if ((0, supabase_service_1.isMockMode)()) {
