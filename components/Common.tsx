...
import { Leaf, Wind, CheckCircle, AlertCircle, Sparkles, ShieldCheck, UploadCloud, ChevronDown, ChevronUp, X, Sprout, Flower, Sun, Droplets, Moon, WifiOff, AlertTriangle } from 'lucide-react';
