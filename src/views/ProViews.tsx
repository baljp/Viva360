...
const ProDashboard: React.FC<{ onViewAgenda: () => void, onViewRecords: () => void, onViewOpportunities: () => void }> = ({ onViewAgenda, onViewRecords, onViewOpportunities }) => {
    return (
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <h2 className="text-3xl font-light text-nature-800">Sofia <span className="font-semibold">Luz</span></h2>
                        </div>
