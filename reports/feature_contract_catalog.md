...
| buscador_chat_social | BUSCADOR | PERSISTIDO_VALIDADO | Não | CHAT_ROOM | /api/chat/*, /api/tribe/* | 0/14/19 | Sim |
| buscador_metamorfose_ritual_retorno | BUSCADOR | MISTO_OU_PARCIAL | Não | DASHBOARD | /api/metamorphosis/* | 0/19/4 | Não |
| buscador_shell_e_config | BUSCADOR | CLIENT_ONLY | Sim | SETTINGS | — | 0/14/21 | Não |
...
| guardiao_shell_e_config | GUARDIAO | CLIENT_ONLY | Sim | SETTINGS | — | 0/12/14 | Não |
