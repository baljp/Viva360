...
Gerado em: 2026-02-25T12:13:21.813Z
...
Mistos/parciais: 0
Não classificados: 0
Validados por catálogo de evidência: 28
...
| buscador_retiro_offline | BUSCADOR | PERSISTIDO_VALIDADO | Não | TRIBE_DASH | /api/tribe/sync, /api/notifications/* | 0/1/7 | Sim |
| buscador_pacto_de_alma | BUSCADOR | PERSISTIDO_VALIDADO | Não | TRIBE_DASH | /api/invites/create, /api/tribe/* | 0/1/7 | Sim |
...
| buscador_jornada_analitica_e_journal | BUSCADOR | PERSISTIDO_VALIDADO | Não | CLIENT_JOURNAL | /api/metamorphosis/*, /api/oracle/history | 0/49/7 | Sim |
| buscador_chat_social | BUSCADOR | PERSISTIDO_VALIDADO | Não | CHAT_SETTINGS | /api/chat/*, /api/tribe/* | 0/14/19 | Sim |
| buscador_metamorfose_ritual_retorno | BUSCADOR | PERSISTIDO_VALIDADO | Não | DASHBOARD | /api/metamorphosis/* | 0/19/4 | Sim |
...
| guardiao_intervencao_clinica | GUARDIAO | PERSISTIDO_VALIDADO | Não | DASHBOARD | /api/clinical/interventions | 0/7/6 | Sim |
| guardiao_alquimia_criar_oferta | GUARDIAO | PERSISTIDO_VALIDADO | Não | ESCAMBO_MARKET | /api/marketplace/products | 0/6/12 | Sim |
| guardiao_agenda_video | GUARDIAO | PERSISTIDO_VALIDADO | Não | VIDEO_SESSION | /api/appointments/* | 0/24/12 | Sim |
| guardiao_financeiro_expandido | GUARDIAO | PERSISTIDO_VALIDADO | Não | FINANCIAL_DASHBOARD | /api/finance/* | 0/10/6 | Sim |
...
| guardiao_santuarios_parceria | GUARDIAO | PERSISTIDO_VALIDADO | Não | SANTUARIO_CONTRACT | /api/spaces/* | 0/12/6 | Sim |
...
| santuario_operacao_completa | SANTUARIO | PERSISTIDO_VALIDADO | Não | FINANCE_OVERVIEW | /api/spaces/*, /api/rooms/*, /api/finance/* | 5/25/3 | Sim |
...
| santuario_salaseestrutura_expandida | SANTUARIO | PERSISTIDO_VALIDADO | Não | ROOM_AGENDA | /api/rooms/* | 6/23/3 | Sim |
| santuario_financeiro_expandido | SANTUARIO | PERSISTIDO_VALIDADO | Não | FINANCE_FORECAST | /api/finance/* | 3/17/3 | Sim |
| santuario_marketplace_eventos_retiros | SANTUARIO | PERSISTIDO_VALIDADO | Não | RETREATS_MANAGE | /api/marketplace/*, /api/events/* | 5/19/3 | Sim |
