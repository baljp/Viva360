    ...
    return (
        <div className="flex flex-col h-screen bg-[#f5f7fa]">
            ...
            <div className="p-4 bg-white border-t border-slate-100 flex items-center gap-3">
                ...
                <button aria-label="Inserir template clínico" onClick={handleInsertClinicalTemplate} className="p-2 text-indigo-300 hover:bg-indigo-50 rounded-full transition-colors"><FileText size={20} /></button>
