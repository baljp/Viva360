...
const clientStateRoutes: Partial<Record<BuscadorState, string>> = {
    ...
    // HISTORY is a cross-flow "hub" screen (currently renders EvolutionView). Treat as Journey route.
...
export const ClientViews: React.FC<{
    ...
    const { state: flowState, go, jump, back, reset, refreshData, notify } = useBuscadorFlow();
