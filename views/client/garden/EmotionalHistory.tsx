            ...
            <div className="flex flex-col h-full bg-nature-50/20 px-6 pt-8 pb-32">
                ...
                <div className="flex gap-3 mb-8">
                    <div className="flex-1 bg-white px-5 py-4 rounded-2xl border border-white shadow-sm flex items-center gap-3">
                        ...
                        <input type="text" placeholder="Buscar sentimento..." className="bg-transparent border-none text-sm focus:ring-0 placeholder:text-nature-300 w-full" />
                    </div>
                    <button className="w-14 h-14 bg-white rounded-2xl border border-white shadow-sm flex items-center justify-center text-nature-600 active:scale-95 transition-all">
                        <Filter size={20} />
                    </button>
                </div>
                    ...
                    <div className="space-y-10 relative z-10">
                        ...
                        {snaps.length === 0 && (
                            <div className="py-32 text-center">
                                ...
                                <p className="text-xs text-nature-300 font-medium px-12 mt-2">Sua jornada de memórias aparecerá aqui conforme você realizar seus rituais.</p>
                            </div>
                        )}
                    </div>
                </div>
