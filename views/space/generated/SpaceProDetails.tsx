...
export default function SpaceProDetails() {
    ...
    const pro = (state.data.team.find(p => p.id === state.selectedProId) as Professional) || {
        id: 'none',
    ...
    const stats = {
        sessions: Number(pro.totalHealingHours || 0),
        rating: Number(pro.rating || 0),
        reviews: Number(pro.reviewCount || 0),
        karma: Number(pro.karma || 0),
    };
